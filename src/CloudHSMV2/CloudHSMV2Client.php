<?php
namespace ILAB_Aws\CloudHSMV2;

use ILAB_Aws\AwsClient;

/**
 * This client is used to interact with the **AWS CloudHSM V2** service.
 * @method \ILAB_Aws\Result copyBackupToRegion(array $args = [])
