 ...
 * @method \ILAB_Aws\Result backtrackDBCluster(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result createDBClusterEndpoint(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result deleteDBClusterEndpoint(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result deleteDBInstanceAutomatedBackup(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result describeDBClusterBacktracks(array $args = []) (supported in versions 2014-10-31)
 * @method \GuzzleHttp\Promise\Promise describeDBClusterBacktracksAsync(array $args = []) (supported in versions 2014-10-31)
 * @method \ILAB_Aws\Result describeDBClusterEndpoints(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result describeDBInstanceAutomatedBackups(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result describeValidDBInstanceModifications(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result modifyCurrentDBClusterCapacity(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result modifyDBClusterEndpoint(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result restoreDBInstanceFromS3(array $args = []) (supported in versions 2014-10-31)
 * @method \GuzzleHttp\Promise\Promise restoreDBInstanceFromS3Async(array $args = []) (supported in versions 2014-10-31)
 * @method \ILAB_Aws\Result startDBCluster(array $args = []) (supported in versions 2014-10-31)
 ...
 * @method \ILAB_Aws\Result stopDBCluster(array $args = []) (supported in versions 2014-10-31)
